...
# 多 seed 比较并导出：
# python single_file_llm_guided_rl_v2.py --mode compare --episodes 5 --compare-modes baseline_sac,rule_hier,llm_hier --compare-num-seeds 3 --compare-save-csv compare_summary.csv --compare-save-latex compare_table.tex
# 指定 seeds：
# python single_file_llm_guided_rl_v2.py --mode compare --episodes 5 --compare-seeds 42,142,242 --compare-save-json compare_results.json --compare-save-csv compare_summary.csv --compare-save-latex compare_table.tex
