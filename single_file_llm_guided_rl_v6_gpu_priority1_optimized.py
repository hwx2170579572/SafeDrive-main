...
class ConstrainedSACAgent(SACAgent):
    """
    First-priority stabilized constrained SAC:
    - only optimize collision + headway constraints in the dual branch
    - keep overspeed + comfort as logging / evaluation costs and reward-shaping signals
    - update lambda from batch immediate-cost mean, not from cost-critic prediction
    """
